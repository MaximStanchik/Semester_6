...
namespace DAL_Celebrity_MSSQL
{
    ...
    {
        public const string DEFOULT_CS = @"Server=localhost,1433; Database=ASP; User Id=sa; Password=StrongP@ssw0rd; TrustServerCertificate=True;";
        ...
        {
            return GetAllLifeevents().Where(l => l.CelebrityId == celebrityId).ToList<Lifeevent>();
        }
