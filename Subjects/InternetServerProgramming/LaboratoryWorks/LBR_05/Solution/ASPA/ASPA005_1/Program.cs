...
using (IRepository repository = CelebrityRepository.Create("Celebrities"))
{
    ...
    }).AddEndpointFilter(async (context, next) =>
    {
        ...
        if (celebrity == null)
        {
            throw new ArgumentNullException(nameof(celebrity), "Celebrity object is required.");
        }
    ...
    .AddEndpointFilter(async (context, next) =>
    {
        ...
        {
            throw new SaveException("Duplicate surname.");
        }
    ...
    .AddEndpointFilter(async (context, next) =>
    {
        ...
        var filePath = Path.Combine(Directory.GetCurrentDirectory(), "Celebrities", fileName);
